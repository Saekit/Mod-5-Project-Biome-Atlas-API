...
#Biomes
Biome.create(biome_name: "Aquatic", temp_range: "varies from -40F to over 100F", ecosystems: "Freshwater and marine.", biodiversity: "High", image: nil)

Biome.create(biome_name: "Tundra", temp_range: "varies from -50F to 50F", ecosystems: "Treeless regions found in the Arctic and on the tops of mountains, where the climate is cold and windy and rainfall is scant.", biodiversity: "Low", image: nil)

Biome.create(biome_name: "Desert", temp_range: "varies from 0F to 120F", ecosystems: "Arid and dry, get less than 10 inches of rain per year. Deserts can be hot or cold.", biodiversity: "Low", image: nil)

Biome.create(biome_name: "Rainforest", temp_range: "70F to 85F", ecosystems: "Hot and moist climate; found near the Earth's equator. Recieves very high rainfall each year.", biodiversity: "High", image: nil)

Biome.create(biome_name: "Grasslands", temp_range: "varies from -40F to over 100F", ecosystems: "Mainly grass; a few trees and shrubs also grow here.", biodiversity: "Medium", image: nil)

Biome.create(biome_name: "Taiga", temp_range: "varies from -65F to 30F", ecosystems: "Boreal forest or snow forest; consisting mostly of pines, spruces, and larches", biodiversity: "Low", image: nil)

Biome.create(biome_name: "Deciduous Forest", temp_range: "varies from 30F to 90F", ecosystems: "Has four distinct seasons: winter, spring, summer, and fall. Winters are cold and summers are warm.", biodiversity: "Medium", image: nil)


#Animals
#Aquatic Biome:
Animal.create(species: "Dumbo Octopus (Grimpoteuthis)", lifespan: "3-5 years", size: "20-30cm (7.9-12in)", prey: "polychaete worms, pelagic copepods, isopods, amphipods, and other crustaceans", predators: "sharks and predatory cephalopods", location: "in the waters of New Zealand, Australia, Monterey Bay, Oregon, Philippines, Martha's Vineyard, Papua New Guinea and Azores", other_info: "Most species of Grimpoteuthis live at depths of at least 3,000 to 4,000 metres (9,800 to 13,100 ft) with some living up to 7,000 metres (23,000 ft) below sea level, which is the deepest of any known octopus.", endangered: false, biome_id: Biome.find_by(biome_name: "Aquatic").id, image: nil)

Animal.create(species: "Blobfish (Psychrolutes marcidus)", lifespan: "around 130 years", size: "up to 30cm (12in)", prey: "crustaceans, sea urchins, shellfish and sea pens", predators: "none", location: "deep waters off the coasts of mainland Australia and Tasmania, as well as the waters of New Zealand", other_info: "They have acid-like skin, making them inedible to other sea creatures.", endangered: true, biome_id: Biome.find_by(biome_name: "Aquatic").id, image: nil)
...
Animal.create(species: "Greenland Shark (Somniosus microcephalus)", lifespan: "300 - 500 years", size: "up to 6.4 - 7.3 meters (21-24ft)", prey: "smaller sharks, skates, eels, herring, capelin, Arctic char, cod, rosefish, sculpins, lumpfish, wolffish, and flounder", predators: "none", location: "waters of the North Atlantic Ocean and Arctic Ocean", other_info: "Greenland sharks have also been found with remains of seals, polar bears, horses, moose, and reindeer (in one case an entire reindeer body) in their stomachs.", endangered: false, biome_id: Biome.find_by(biome_name: "Aquatic").id, image: nil)
...
Animal.create(species: "White-tailed Deer (Odocoileus virginianus)", lifespan: "6-14 years", size: "2.6-3.3ft tall", prey: "nuts, corn, acorns, buds, bark, and shoots", predators: "wolves, mountain lions, bears, jaguars, and coyotes", location: "from southern Canada to South America", other_info: "White-tailed deer communicate through the use of their white tail. When spooked, it will raise its tail to warn the other deer in the immediate area.", endangered: false, biome_id: Biome.find_by(biome_name: "Deciduous Forest").id, image: nil)

Animal.create(species: "Grizzly Bear (Ursus arctosssp.)", lifespan: "20-25 years", size: "6.5ft long", prey: "roots, fruits, berries, grasses, and forbs, fish and rodents", predators: "wolves, mountain lions, other bears", location: "North America", other_info: "Grizzly bears hibernate for 5–7 months each year except where the climate is warm, as the California grizzly did not hibernate.", endangered: false, biome_id: Biome.find_by(biome_name: "Deciduous Forest").id, image: nil)


#Plants
#Aquatic
Plant.create(species: "Kelp (Laminariales)", size: "30-80 meters (100-260 ft)", predators: "many fish and invertebrates", location: "in shallow oceans", seed_distribution: "spread spores", other_info: "Kelp grows in underwater forests (kelp forests) in shallow oceans, and is thought to have appeared in the Miocene, 23 to 5 million years ago.", biome_id: Biome.find_by(biome_name: "Aquatic").id, image: nil)

#
# #Tundra
Plant.create(species: "Bearberries (Arctostaphylos)", size: "10–30 cm high (3.9–11.8 in)", predators: "deer, elk, bighorn sheep and moose", location: "northern North America, Asia and Europe, and Central America", seed_distribution: "animals that eat the berries", other_info: "The leaves are picked any time during the summer and dried for use in teas, liquid extracts, medicinal tea bags and tablets for traditional medicine uses.", biome_id: Biome.find_by(biome_name: "Tundra").id, image: nil)

#
# #Desert
Plant.create(species: "Saguaro Cactus (Carnegiea gigantca)", size: "40-60 ft tall", predators: "the Long-Nosed bat, bees, wasps, ants, and butterflies drink the nectar of the Cactus flower. Small animals such as the Pack Rat, and Pocket Mice will come to eat the Cactus", location: "Sonoran Desert", seed_distribution: "Pollination is carried out by nectar feeding bats, birds and insects", other_info: "The saguaro cactus flowers every year and can have up to 200 blooms. It can withstand high temperatures, but cannot survive temperatures below freezing.", biome_id: Biome.find_by(biome_name: "Desert").id, image: nil)
...
#
# #Grasslands
Plant.create(species: "Purple Needlegrass (Nassella pulchra)", size: "3.3ft", predators: "elk, deer, pronghorns, and cattle", location: "California", seed_distribution: "Because grasses are wind pollinated, they do not need showy flowers to attract insects.", other_info: "The extensive root system can reach 20 feet (6.1 m) deep into the soil, making the grass more tolerant of drought.", biome_id: Biome.find_by(biome_name: "Grasslands").id, image: nil)

#
# #Taiga
Plant.create(species: "Peat Moss (Sphagnum)", size: "0.2-10cm (0.1-3.9in) tall", predators: "many animals just nibble on moss, because it contains moisture, such as water and other liquids", location: "North America", seed_distribution: "spores", other_info: "Has no true root system, and is part dead and part alive.", biome_id: Biome.find_by(biome_name: "Taiga").id, image: nil)
